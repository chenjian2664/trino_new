...
public class TestPrometheusSplit
{
    ...
    public void testQueryWithTableNameNeedingURLEncodeInSplits()
    {
        ...
        PrometheusSplit split = (PrometheusSplit) splits.getNextBatch(1, new ConnectorDynamicFilter(TupleDomain.all(), true)).getNow(null).getSplits().get(0);
    ...
    public void testQueryDividedIntoSplitsLastSplitHasRightTime()
    {
        ...
        ConnectorSplitSource splitsMaybe = splitManager.getSplits(
                ...
                ImmutableSet.of(),
                Constraint.alwaysTrue());
        List<ConnectorSplit> splits = splitsMaybe.getNextBatch(NUMBER_MORE_THAN_EXPECTED_NUMBER_SPLITS, new ConnectorDynamicFilter(TupleDomain.all(), true)).getNow(null).getSplits();
    ...
    public void testQueryDividedIntoSplitsShouldHaveCorrectSpacingBetweenTimes()
    {
        ...
        ConnectorSplitSource splits = splitManager.getSplits(
                ...
                ImmutableSet.of(),
                Constraint.alwaysTrue());
        PrometheusSplit split1 = (PrometheusSplit) splits.getNextBatch(1, new ConnectorDynamicFilter(TupleDomain.all(), true)).getNow(null).getSplits().get(0);
        ...
        PrometheusSplit split2 = (PrometheusSplit) splits.getNextBatch(1, new ConnectorDynamicFilter(TupleDomain.all(), true)).getNow(null).getSplits().get(0);
