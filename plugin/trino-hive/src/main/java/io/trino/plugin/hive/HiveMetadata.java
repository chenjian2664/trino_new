        ...
        implements TransactionalMetadata
{
    ...
    public ConnectorAnalyzeMetadata getStatisticsCollectionMetadata(ConnectorSession session, ConnectorTableHandle tableHandle, Map<String, Object> analyzeProperties)
    {
        ...
        if (partitionValuesList.isPresent()) {
            ...
            handle = partitionManager.applyPartitionResult(handle, partitions, alwaysTrue(), session);
        }
    ...
    public Optional<ConstraintApplicationResult<ConnectorTableHandle>> applyFilter(ConnectorSession session, ConnectorTableHandle tableHandle, Constraint constraint)
    {
        ...
        HiveTableHandle newHandle = partitionManager.applyPartitionResult(handle, partitionResult, constraint, session);
