...
public class HivePartitionManager
{
            ...
            Optional<PartitionProjection> partitionProjection)
    {
        ...
        for (int i = 0; i < partitionColumns.size(); i++) {
            ...
            NullableValue parsedValue = partitionProjection.flatMap(projection -> projection.resolvePartitionValue(column.getName(), partitionValue))
                    .orElseGet(() -> parsePartitionValue(partitionName, partitionValue, column.getType()));
