...
public class InternalHiveSplitFactory
{
            ...
            ConnectorExpressionEvaluator connectorExpressionEvaluator)
    {
        ...
        this.prepared = requireNonNull(connectorExpressionEvaluator, "connectorExpressionEvaluator is null")
    ...
    private boolean pathMatchesPredicate(Optional<Domain> pathDomain, String path)
    {
        ...
        return !Boolean.FALSE.equals(prepared.evaluate(ImmutableMap.of(pathVariableName.get(), new NullableValue(PATH_TYPE, pathSlice))).orElse(null));
    }
}
