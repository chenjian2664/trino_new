        ...
        implements ConnectorSplitSource
{
    ...
    public CompletableFuture<ConnectorSplitBatch> getNextBatch(int maxSize, ConnectorDynamicFilter dynamicFilter)
    {
        ...
        synchronized (closer) {
            ...
            nextBatchFuture = executor.submit(() -> getNextBatchInternal(maxSize, dynamicFilter));
    ...
    private synchronized ConnectorSplitBatch getNextBatchInternal(int maxSize, ConnectorDynamicFilter dynamicFilter)
    {
        TupleDomain<IcebergColumnHandle> dynamicFilterPredicate = dynamicFilter.currentPredicate()
